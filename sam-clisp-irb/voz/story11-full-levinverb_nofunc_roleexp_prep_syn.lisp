  ...
  '(STORY-11
     (:discourse
       ...
       (:templates
         ...
         (t1004 (STORY11-EXTRA4  (STORY11-m1000 "The soldier") " is the " (Other "Other") ) ".")
         (t1005 (STORY11-EXTRA5  (STORY11-m1002 "the maiden") " is the " (Other "Other") ) ".")
         (t10 "" (STORY11-VERB2 "" (STORY11-m1001 "The king") " married " (STORY11-m1002 "the maiden") " " ) ". ")
         (t11 "" (STORY11-m1000 "The soldier") " was made a noble man by the king and married another lady in the court . ")
         (t1006 (STORY11-EXTRA6  (STORY11-m1000 "The soldier") " is the " (Other "Other") ) ".")
         (t1007 (STORY11-EXTRA7  (STORY11-m1002 "the maiden") " is the " (Other "Other") ) ".")
     ...
     (:structure
       ...
       (phase3
         ...
         (:expressions
           ((levin-10-5 STORY11-m1000 STORY11-m1002) :name STORY11-VERB1)
           ((roleOther STORY11-m1000) :name STORY11-EXTRA3)
           ((roleOther STORY11-m1002) :name STORY11-EXTRA4)
         )
       )
       (phase4
         (:entities
         ...
         (:expressions
           ((levin-36-2 STORY11-m1001 STORY11-m1002) :name STORY11-VERB2)
           ((roleOther STORY11-m1000) :name STORY11-EXTRA5)
           ((roleOther STORY11-m1002) :name STORY11-EXTRA6)
         )
       )
