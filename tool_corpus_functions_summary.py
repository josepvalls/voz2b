...
def get_docs_stats():
    ...
    if DO_WRITE_FILES:
        open('tool_corpus_functions_summary/tool_corpus_functions_summary.tsv','w').write(tsv)
        open('tool_corpus_functions_summary/tool_corpus_functions_summary.arff','w').write(arff)
